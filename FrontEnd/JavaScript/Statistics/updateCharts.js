...
function updateSelectedChart(newChart) {
  ...
  if (newChart == "pie") getPieBarChartData("pie");
  if (newChart == "bar") getPieBarChartData("bar");
  if (newChart == "line") getLineChartData();
  if (newChart == "-") console.log("No chart selected");
}
