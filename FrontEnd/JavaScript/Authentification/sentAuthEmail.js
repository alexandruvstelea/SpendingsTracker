...
function verifyCode() {
  if (
    document.getElementById("insertVerificationCode").value ==
    verificationNumber
  ) {
    $("#login-box").show();
    $("#register-box").hide();
    ...
    document
      .getElementById("errorValidationEmailMessage")
      .setAttribute("style", "display:block");
    document.getElementById("insertValidationEmailError").innerHTML =
      "Invalid Code";
  }
}
