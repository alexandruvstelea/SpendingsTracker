...
function editSpending() {
  const url =
    "http://127.0.0.1:5000/updatespending?" +
    new URLSearchParams({
      id: currentEditId,
...
function inputValidateEdit() {
  ...
  if (
    parseFloat(document.getElementById("valueEditSpending").value) === 0 ||
    Math.sign(document.getElementById("valueEditSpending").value) === -1
  ) {
