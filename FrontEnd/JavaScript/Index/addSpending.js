async function addSpending() {
  ...
  const url =
    "http://127.0.0.1:5000/insertspending?" +
    new URLSearchParams({
      name: name,
      category: category,
      value: value,
...
function inputValidate() {
  ...
  if (
    parseFloat(document.getElementById("valueAddSpending").value) < 1 ||
    Math.sign(document.getElementById("valueAddSpending").value) === -1
  ) {
