...
function showCategoriesDropdown() {
  document
    .getElementById("myDropdownCategoryFilter")
    .classList.toggle("showCategoryFilter");
}

function showOrderDropdown() {
  document
    .getElementById("myDropdownOrderFilter")
    .classList.toggle("showOrderFilter");
}
...
window.addEventListener("click", function (event) {
  if (!event.target.matches(".dropbtnCategoryFilter")) {
    var dropdowns = document.getElementsByClassName(
      "dropdownCategoryFilter-content"
    );
    var i;
